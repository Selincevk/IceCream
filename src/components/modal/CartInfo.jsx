...
<span className='font-semibold text-gray-700'>
    {subTotal}₺
      ...
      <p className='flex justify-between py-2'>
        ...
        <span>{subTotal > 100 ? "Ücretsiz" : `${shipping}₺`}</span>
      </p>
...
<span className='font-semibold text-gray-700'>
    {total}₺
      ...
      <button onClick={handleClick} className="bg-red-500 mt-4 w-full p-2 rounded-md text-white hover:bg-red-600 transition disabled:bg-red-300">Sipariş Ver</button>
    </div>
  )
}
