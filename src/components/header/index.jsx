  ...
  return (
    <header className="flex justify-between fs-5">
        <div className="flex gap-[18px] items-center"> 
            ...
            <h2 className="font-black max-sm:hidden tracking-widest fs-4">Drop <br /> Cream </h2> 
            {/* tracking-widest: harf aralığını artırmak için  */}
        </div>
...
<a href=""><IoIosSearch className="text-[24px] 2xl:text-[40px]" /></a>
        </nav>
